...
public class BasePage {
    ...
    public void waitToElementInvisible(WebDriver driver, String locatorType) {
        WebDriverWait waitExplicit = new WebDriverWait(driver,  Duration.ofSeconds(30));
    ...
    public void clickToHeader(WebDriver driver, String menuLink) {
        waitForElementClickable(driver, HomePageUIs.MENU_LINK, menuLink);
        clickToElement(driver, HomePageUIs.MENU_LINK, menuLink);
    }


    public void clickToCategoryLink(WebDriver driver, String category) {
        waitForElementClickable(driver, HomePageUIs.PRODUCT_NAME,category);
        clickToElement(driver, HomePageUIs.PRODUCT_NAME,category);
    }
}
